# How BENE AI Agents Caught an 8% Model Regression Before It Left CI

*MLOps*

*A model swap dropped code_review accuracy from 0.83 to 0.76. BENE AI agents ran 5 benchmarks, detected the regression, blocked the deploy, and ran a targeted Meta-Harness re-optimization that restored 0.83 — all in CI, no human in the loop.*
...
Most teams find out from user reports. BENE catches it in CI, in 12 minutes, before the deploy leaves the gate.

---

![BENE regression guard demo — 5 benchmarks, code_review regresses 8.4%, CI gate blocks deploy, Meta-Harness re-optimizes](../demos/bene_uc_regression.gif)
...
Most teams find this regression from user reports, support tickets, or a 3am alert. BENE finds it in CI.
...
This is the full MLOps loop that BENE makes systematic:
...
- [Component guide: Meta-Harness](../meta-harness.md)
- [Use case: Model Regression Guard](../use-cases.md#model-regression-guard)
- [Tutorial: t01 — Meta-Harness from 48% to 83%](t01-bene-meta-harness.md)
