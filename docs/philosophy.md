...
| Stagnation + co-evolution | CORAL (arXiv:2604.01658) | The proposer plateauing on one harness shape | [meta-harness.md#coral-stagnation-detection--multi-agent-co-evolution-v060](meta-harness.md#coral-stagnation-detection--multi-agent-co-evolution-v060) |
...
![Containment in action — one agent rolled back, others untouched](demos/bene_uc_safety.gif)
